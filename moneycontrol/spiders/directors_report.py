...
TOGGLING_DIV_NUM=6
#somehow in browser content shows in tr[3] but in scrapy content shows up in tr[2]
TEXT_XPATH6='/html/body/center[2]/div/div/div[6]/div[3]/div[2]/div[1]/div/div[2]/table[2]/tr[2]/td/pre/text()';
TEXT_XPATH8='/html/body/center[2]/div/div/div[8]/div[3]/div[2]/div[1]/div/div[2]/table[2]/tr[2]/td/pre/text()';
...
class DataSpider(scrapy.Spider):
    name = "txt_data_dr"           # name with which scrapy recognises spider
    ...
    def start_requests(self):
        ...
        cursor = conn.cursor()
        cursor.execute(
            "select concat('http://www.moneycontrol.com/annual-report/infosys/directors-report/',mc_symbol,'#',mc_symbol),mc_symbol,symbol from symbol_mc_map ;"
        )
    ...
    def parse(self, response):
        ...
        finData['type']='dr'        # directors report
