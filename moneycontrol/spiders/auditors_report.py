...
class DataSpider(scrapy.Spider):
    name = "txt_data_ar"           # name with which scrapy recognises spider
    ...
    def start_requests(self):
        ...
        cursor = conn.cursor()
        cursor.execute(
            "select concat('http://www.moneycontrol.com/annual-report/infosys/auditors-report/',mc_symbol,'#',mc_symbol),mc_symbol,symbol from symbol_mc_map ;"
        )
    ...
    def parse(self, response):
        ...
        finData['type']='ar'        # auditors report
